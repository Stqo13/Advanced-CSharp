...
class Program
{
    static void Main(string[] args)
    {
        ...
        {           
            ...
            bool isOutOfBounds = rowPosition < 0 || rowPosition >= n || colPosition < 0 || colPosition >= n;
            if (isOutOfBounds)
            {
                if (rowPosition < 0) rowPosition = n - 1;
                else if (rowPosition >= n) rowPosition = 0;
                else if (colPosition < 0) colPosition = n - 1;
                else if (colPosition >= n) colPosition = 0;
            }
        }
